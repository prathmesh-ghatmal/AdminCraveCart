...
import com.example.admincravecart.model.UserModel
...
class SignupActivity : AppCompatActivity() {
    ...
    private lateinit var resturantname: String
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.CreateAccountButton.setOnClickListener {
            ...
            username = binding.SIgnInName.text.toString().trim()
            resturantname = binding.SIgnInResturantName.text.toString().trim()
            email = binding.SIgnInEmail.text.toString().trim()
            password = binding.SIgnInPassword.text.toString().trim()
            //checking any fields are blank or not
            if (username.isBlank() || resturantname.isBlank() || email.isBlank() || password.isBlank()) {
...
//  saving data into the database
    private fun SaveUserData() {
        ...
        email = binding.SIgnInEmail.text.toString().trim()
        password = binding.SIgnInPassword.text.toString().trim()
        val user=UserModel(username,resturantname,email,password)
